...
function createTerminus (server, options = {}) {
  ...
  // add the healthcheck to the internal states
  internal.healthChecks = healthChecks
...
async function getStatus (url) {
  if (!internal.healthChecks || !internal.healthChecks[url]) {
    throw new HealthCheckNotFoundError()
  }

  return internal.healthChecks[url]()
}
